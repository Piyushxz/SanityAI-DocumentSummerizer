...
export const DeleteModal = ()=>{
    ...
    >
         <div className="w-96 bg-black h-48 border border-gray-600/70 shadow-xl rounded-lg">
                ...
                <div className="flex justify-end gap-4 p-4">
                    ...
                    className="flex items-center  bg-red-600 hover:bg-red-600/50 rounded-lg px-1 gap-1 py-2">
                        <DeleteIcon className="text-white size-6 "/>
                        <h1 className="font-primary text-white">Delete</h1>
                    </button>
                </div>
         </div>
        </motion.div>
